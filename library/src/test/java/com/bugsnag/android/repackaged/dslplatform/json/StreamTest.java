...
public class StreamTest {
	...
	public static class JsonPoint implements JsonObject {
		...
		public void serialize(final JsonWriter sw, final boolean minimal) {
			sw.writeAscii("{\"y\":");
			NumberConverter.serialize(y, sw);
			sw.writeByte(JsonWriter.OBJECT_END);
		}

		public static final JsonReader.ReadJsonObject<JsonPoint> JSON_READER = new JsonReader.ReadJsonObject<JsonPoint>() {
			@SuppressWarnings("unchecked")
			@Override
			public JsonPoint deserialize(final JsonReader reader) throws java.io.IOException {
				return new JsonPoint(reader);
			}
		};

		private JsonPoint(final JsonReader<Object> reader) throws java.io.IOException {
